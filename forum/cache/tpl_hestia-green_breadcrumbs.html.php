<?php if (!defined('IN_PHPBB')) exit; ?><table class="tablebg breadcrumb" width="100%" cellspacing="<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_SPACING'])) ? $this->_tpldata['DEFINE']['.']['CA_SPACING'] : ''; ?>" cellpadding="0" style="margin-top: 5px;">
	<tr>
		<td class="row1">
