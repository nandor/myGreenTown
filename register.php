...
<center id ="register_window">
	...
	<div id = "register_warning"><?php echo _("hello"); ?></div>
	<table>
		<tr>
		...
		<tr>
			...
			<td><?php echo _("Enter the code from the image"); ?><br /><input type = "text" id = "captcha" class = "input_big" /></td>
		</tr>
	</table>
	<input type = 'button' value = '<?php echo _("Register");?>' class = "button_register" onclick = "register()"/>
